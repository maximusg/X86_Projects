...
;./assign2 //will execute the program.
;echo $? //will print the global variable "swaps" which gets saved as exit status code prior to exit
bits 64
...
_start:
        ...
        mov     edi, [passes]		;set edi reg to "passes" value as exit status code
...
section .bss                        ;uninitialized data w/ global and static vars
